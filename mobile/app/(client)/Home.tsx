  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.grid}>
        ...
        <TouchableOpacity style={styles.card} onPress={() => Alert.alert('Próximamente', 'Próximamente')}>
          <Text style={styles.cardEmoji}>📊</Text>
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#3b82f6', paddingVertical: 40, paddingHorizontal: 20, alignItems: 'center', borderBottomLeftRadius: 30, borderBottomRightRadius: 30 },
  ...
  card: { width: '47%', backgroundColor: 'white', borderRadius: 16, padding: 16, alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3, marginBottom: 8 },
  cardEmoji: { fontSize: 32, marginBottom: 8 },
  cardTitle: { fontSize: 16, fontWeight: 'bold', marginBottom: 4 },
  cardDesc: { fontSize: 12, color: '#666', textAlign: 'center' },
  logoutButton: { backgroundColor: '#ef4444', margin: 16, padding: 14, borderRadius: 12, alignItems: 'center', marginBottom: 40 },
